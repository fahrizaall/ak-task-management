...
<head>
  ...
  <title>Task Management - OpenAPI 1.0</title>
...
<body>
  ...
  "properties" : {
    ...
    "title" : {
      "type" : "string",
      "format" : "varchar",
      "example" : "Sebuah Judul"
    },
    "description" : {
      "type" : "string",
      "format" : "text",
      "example" : "Ini merupakan contoh deskripsi"
    },
    "start_date" : {
      "type" : "string",
      "format" : "date-time"
  ...
  <div class="container-fluid">
    <div class="row-fluid">
        ...
        <nav id="scrollingNav">
          <ul class="sidenav nav nav-list">
            ...
            <li class="nav-fixed nav-header active" data-group="_"><a href="#api-_">API Summary</a></li>
                  ...
                  <li class="nav-header" data-group="Task"><a href="#api-Task">API Methods - Task</a></li>
                    <li data-group="Task" data-name="taskGet" class="">
                      <a href="#api-Task-taskGet">taskGet</a>
                    </li>
                    <li data-group="Task" data-name="taskPost" class="">
                      <a href="#api-Task-taskPost">taskPost</a>
                    </li>
                    <li data-group="Task" data-name="taskPut" class="">
                      <a href="#api-Task-taskPut">taskPut</a>
                    </li>
                    <li data-group="Task" data-name="taskTaskIdDelete" class="">
                      <a href="#api-Task-taskTaskIdDelete">taskTaskIdDelete</a>
                    </li>
                    <li data-group="Task" data-name="taskTaskIdGet" class="">
                      <a href="#api-Task-taskTaskIdGet">taskTaskIdGet</a>
                    </li>
                  <li class="nav-header" data-group="TaskCategories"><a href="#api-TaskCategories">API Methods - TaskCategories</a></li>
                    <li data-group="TaskCategories" data-name="taskCategoriesGet" class="">
                      <a href="#api-TaskCategories-taskCategoriesGet">taskCategoriesGet</a>
                    </li>
                    <li data-group="TaskCategories" data-name="taskCategoriesPost" class="">
                      <a href="#api-TaskCategories-taskCategoriesPost">taskCategoriesPost</a>
                    </li>
                    <li data-group="TaskCategories" data-name="taskCategoriesPut" class="">
                      <a href="#api-TaskCategories-taskCategoriesPut">taskCategoriesPut</a>
                    </li>
                    <li data-group="TaskCategories" data-name="taskCategoriesTaskCategoriesIdDelete" class="">
                      <a href="#api-TaskCategories-taskCategoriesTaskCategoriesIdDelete">taskCategoriesTaskCategoriesIdDelete</a>
                    </li>
                    <li data-group="TaskCategories" data-name="taskCategoriesTaskCategoriesIdGet" class="">
                      <a href="#api-TaskCategories-taskCategoriesTaskCategoriesIdGet">taskCategoriesTaskCategoriesIdGet</a>
                    </li>
          </ul>
        </nav>
      </div>
      <div id="content">
        <div id="project">
          <div class="pull-left">
            <h1>Task Management - OpenAPI 1.0</h1>
          </div>
        ...
        <div id="header">
          <div id="api-_">
            ...
            <hr>
            <div>Api ini merupakan public api yang berisi data task</div>
          </div>
        </div>
        <div id="sections">
                <section id="api-Task">
                  <h1>Task</h1>
                    <div id="api-Task-taskGet">
                      <article id="api-Task-taskGet-0" data-group="User" data-name="taskGet" data-version="0">
                        <div class="pull-left">
                          <h1>taskGet</h1>
                          <p>Finds all task</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Mengambil data semua task pada database</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/task</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Task-taskGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Task-taskGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Task-taskGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Task-taskGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Task-taskGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Task-taskGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Task-taskGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Task-taskGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Task-taskGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Task-taskGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Task-taskGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Task-taskGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://mf-task-management.herokuapp.com/api/v1/task"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Task-taskGet-0-java">
...
public class TaskApiExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            array[Task] result = apiInstance.taskGet();
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Task-taskGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Task-taskGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Task-taskGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">
TaskApi *apiInstance = [[TaskApi alloc] init];

// Finds all task
[apiInstance taskGetWithCompletionHandler: 
              ^(array[Task] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Task-taskGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskApi()
...
api.taskGet(callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Task-taskGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Task-taskGet-0-csharp">
        ...
        public void main()
        {
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling TaskApi.taskGet: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Task-taskGet-0-php">
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Task-taskGet-0-perl">
...
eval { 
    my $result = $api_instance->taskGet();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TaskApi->taskGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Task-taskGet-0-python">
...
try: 
    # Finds all task
    api_response = api_instance.task_get()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TaskApi->taskGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-taskGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-taskGet-200-schema">
                                  <div id='responses-taskGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = ;
                                        ...
                                        $('#responses-taskGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-taskGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-taskGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Task-taskPost">
                      <article id="api-Task-taskPost-0" data-group="User" data-name="taskPost" data-version="0">
                        <div class="pull-left">
                          <h1>taskPost</h1>
                          <p>Add a new task</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Menambahkan data task baru ke database</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/task</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Task-taskPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Task-taskPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-Task-taskPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Task-taskPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Task-taskPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Task-taskPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Task-taskPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Task-taskPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Task-taskPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Task-taskPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Task-taskPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Task-taskPost-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
-H "Accept: application/json"\
-H "Content-Type: application/json"\
"https://mf-task-management.herokuapp.com/api/v1/task"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Task-taskPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
    ...
    public static void main(String[] args) {
        ...
        TaskApi apiInstance = new TaskApi();
        Task body = ; // Task | Create a new task
        try {
            Task result = apiInstance.taskPost(body);
            System.out.println(result);
        } catch (ApiException e) {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Task-taskPost-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Task-taskPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Task-taskPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Task *body = ; // Create a new task

TaskApi *apiInstance = [[TaskApi alloc] init];

// Add a new task
[apiInstance taskPostWith:body
              completionHandler: ^(Task output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Task-taskPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskApi()
var body = ; // {{Task}} Create a new task
...
api.taskPost(body, callback);
                            ...
                            <!--<div class="tab-pane" id="examples-Task-taskPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Task-taskPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskPostExample
    {
        public void main()
        {
            ...
            var apiInstance = new TaskApi();
            var body = new Task(); // Task | Create a new task
            ...
            catch (Exception e)
            {
                Debug.Print("Exception when calling TaskApi.taskPost: " + e.Message );
                            ...
                            <div class="tab-pane" id="examples-Task-taskPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskApi();
$body = ; // Task | Create a new task

try {
    $result = $api_instance->taskPost($body);
    print_r($result);
} catch (Exception $e) {
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Task-taskPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskApi;

my $api_instance = WWW::SwaggerClient::TaskApi->new();
my $body = WWW::SwaggerClient::Object::Task->new(); # Task | Create a new task

eval { 
    my $result = $api_instance->taskPost(body => $body);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TaskApi->taskPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Task-taskPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling TaskApi->taskPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "required" : true
                                  ...
                                  var result = $('#d2e199_taskPost_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_taskPost_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-taskPost-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-taskPost-200-schema">
                                  <div id='responses-taskPost-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = ;
                                        var schema = schemaWrapper.content["application/json"].schema;
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-taskPost-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-taskPost-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-taskPost-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Task-taskPut">
                      <article id="api-Task-taskPut-0" data-group="User" data-name="taskPut" data-version="0">
                        <div class="pull-left">
                          <h1>taskPut</h1>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Update an existing task by Id</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/task</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Task-taskPut-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Task-taskPut-0-java">Java</a></li>
                          <li class=""><a href="#examples-Task-taskPut-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Task-taskPut-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Task-taskPut-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Task-taskPut-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Task-taskPut-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Task-taskPut-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Task-taskPut-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Task-taskPut-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Task-taskPut-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Task-taskPut-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X PUT\
-H "Accept: application/json,application/xml"\
-H "Content-Type: application/json"\
"https://mf-task-management.herokuapp.com/api/v1/task"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Task-taskPut-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
    ...
    public static void main(String[] args) {
        ...
        TaskApi apiInstance = new TaskApi();
        Task body = ; // Task | Update an existent task
        try {
            Task result = apiInstance.taskPut(body);
            System.out.println(result);
        } catch (ApiException e) {
            ...
            e.printStackTrace();
                          ...
                          <div class="tab-pane" id="examples-Task-taskPut-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Task-taskPut-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Task-taskPut-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Task *body = ; // Update an existent task

TaskApi *apiInstance = [[TaskApi alloc] init];

// Update an existing task
[apiInstance taskPutWith:body
              completionHandler: ^(Task output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-Task-taskPut-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskApi()
var body = ; // {{Task}} Update an existent task
...
api.taskPut(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Task-taskPut-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Task-taskPut-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskPutExample
    {
        public void main()
        {

            var apiInstance = new TaskApi();
            var body = new Task(); // Task | Update an existent task
            ...
            {
                Debug.Print("Exception when calling TaskApi.taskPut: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Task-taskPut-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskApi();
$body = ; // Task | Update an existent task

try {
    $result = $api_instance->taskPut($body);
    print_r($result);
} catch (Exception $e) {
...
?></code></pre>
                            ...
                            <div class="tab-pane" id="examples-Task-taskPut-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskApi;

my $api_instance = WWW::SwaggerClient::TaskApi->new();
my $body = WWW::SwaggerClient::Object::Task->new(); # Task | Update an existent task

eval { 
    my $result = $api_instance->taskPut(body => $body);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TaskApi->taskPut: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Task-taskPut-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    ...
    print("Exception when calling TaskApi->taskPut: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_taskPut_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_taskPut_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-taskPut-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-taskPut-200-schema">
                                  <div id='responses-taskPut-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = ;
                                        var schema = schemaWrapper.content["application/json"].schema;
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-taskPut-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-taskPut-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-taskPut-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-Task-taskTaskIdDelete">
                      <article id="api-Task-taskTaskIdDelete-0" data-group="User" data-name="taskTaskIdDelete" data-version="0">
                        <div class="pull-left">
                          <h1>taskTaskIdDelete</h1>
                          <p>Deletes a task</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">menghapus task sesuai id yang diberikan</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/task/{taskId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Task-taskTaskIdDelete-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdDelete-0-java">Java</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdDelete-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Task-taskTaskIdDelete-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Task-taskTaskIdDelete-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdDelete-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Task-taskTaskIdDelete-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Task-taskTaskIdDelete-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdDelete-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdDelete-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdDelete-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Task-taskTaskIdDelete-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X DELETE\
"https://mf-task-management.herokuapp.com/api/v1/task/{taskId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
    ...
    public static void main(String[] args) {
        ...
        TaskApi apiInstance = new TaskApi();
        Long taskId = 789; // Long | Task id to delete
        try {
            apiInstance.taskTaskIdDelete(taskId);
        } catch (ApiException e) {
            System.err.println("Exception when calling TaskApi#taskTaskIdDelete");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Long *taskId = 789; // Task id to delete

TaskApi *apiInstance = [[TaskApi alloc] init];

// Deletes a task
[apiInstance taskTaskIdDeleteWith:taskId
              completionHandler: ^(NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskApi()
var taskId = 789; // {{Long}} Task id to delete
...
api.taskTaskIdDelete(taskId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskTaskIdDeleteExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling TaskApi.taskTaskIdDelete: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskApi();
$taskId = 789; // Long | Task id to delete

try {
    $api_instance->taskTaskIdDelete($taskId);
} catch (Exception $e) {
    echo 'Exception when calling TaskApi->taskTaskIdDelete: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskApi;

my $api_instance = WWW::SwaggerClient::TaskApi->new();
my $taskId = 789; # Long | Task id to delete

eval { 
    $api_instance->taskTaskIdDelete(taskId => $taskId);
};
if ($@) {
    warn "Exception when calling TaskApi->taskTaskIdDelete: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Task-taskTaskIdDelete-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Deletes a task
    api_instance.task_task_id_delete(taskId)
except ApiException as e:
    print("Exception when calling TaskApi->taskTaskIdDelete: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_taskTaskIdDelete_taskId">
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - Invalid task value </h3>
                      ...
                      <hr>
                    <div id="api-Task-taskTaskIdGet">
                      <article id="api-Task-taskTaskIdGet-0" data-group="User" data-name="taskTaskIdGet" data-version="0">
                        <div class="pull-left">
                          <h1>taskTaskIdGet</h1>
                          <p>Find task by id</p>
                        </div>
                        ...
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Mengambil data task sesuai id yang diberikan</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/task/{taskId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-Task-taskTaskIdGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-Task-taskTaskIdGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-Task-taskTaskIdGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-Task-taskTaskIdGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-Task-taskTaskIdGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-Task-taskTaskIdGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-Task-taskTaskIdGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://mf-task-management.herokuapp.com/api/v1/task/{taskId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
    ...
    public static void main(String[] args) {
        ...
        TaskApi apiInstance = new TaskApi();
        Integer taskId = 56; // Integer | id to filter
        try {
            array[Task] result = apiInstance.taskTaskIdGet(taskId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TaskApi#taskTaskIdGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskApi;
...
public class TaskApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *taskId = 56; // id to filter

TaskApi *apiInstance = [[TaskApi alloc] init];

// Find task by id
[apiInstance taskTaskIdGetWith:taskId
              completionHandler: ^(array[Task] output, NSError* error) {
                            ...
                            <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskApi()
var taskId = 56; // {{Integer}} id to filter
...
api.taskTaskIdGet(taskId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-Task-taskTaskIdGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskTaskIdGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling TaskApi.taskTaskIdGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskApi();
$taskId = 56; // Integer | id to filter

try {
    $result = $api_instance->taskTaskIdGet($taskId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TaskApi->taskTaskIdGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskApi;

my $api_instance = WWW::SwaggerClient::TaskApi->new();
my $taskId = 56; # Integer | id to filter

eval { 
    my $result = $api_instance->taskTaskIdGet(taskId => $taskId);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TaskApi->taskTaskIdGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-Task-taskTaskIdGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Find task by id
    api_response = api_instance.task_task_id_get(taskId)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TaskApi->taskTaskIdGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_taskTaskIdGet_taskId">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Integer
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-taskTaskIdGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-taskTaskIdGet-200-schema">
                                  <div id='responses-taskTaskIdGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = ;
                                        var schema = schemaWrapper.content["application/json"].schema;
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-taskTaskIdGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-taskTaskIdGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-taskTaskIdGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                ...
                <section id="api-TaskCategories">
                  <h1>TaskCategories</h1>
                    <div id="api-TaskCategories-taskCategoriesGet">
                      <article id="api-TaskCategories-taskCategoriesGet-0" data-group="User" data-name="taskCategoriesGet" data-version="0">
                        <div class="pull-left">
                          <h1>taskCategoriesGet</h1>
                          <p>Finds all task categories</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Mengambil data semua task categories pada database</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/task_categories</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TaskCategories-taskCategoriesGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TaskCategories-taskCategoriesGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://mf-task-management.herokuapp.com/api/v1/task_categories"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskCategoriesApi;

import java.io.File;
import java.util.*;

public class TaskCategoriesApiExample {

    public static void main(String[] args) {
        
        TaskCategoriesApi apiInstance = new TaskCategoriesApi();
        try {
            array[TaskCategories] result = apiInstance.taskCategoriesGet();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TaskCategoriesApi#taskCategoriesGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">
TaskCategoriesApi *apiInstance = [[TaskCategoriesApi alloc] init];

// Finds all task categories
[apiInstance taskCategoriesGetWithCompletionHandler: 
              ^(array[TaskCategories] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskCategoriesApi()
var callback = function(error, data, response) {
  if (error) {
    console.error(error);
  } else {
...
api.taskCategoriesGet(callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskCategoriesGetExample
    {
        public void main()
        {

            var apiInstance = new TaskCategoriesApi();
            ...
            {
                Debug.Print("Exception when calling TaskCategoriesApi.taskCategoriesGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskCategoriesApi();

try {
    $result = $api_instance->taskCategoriesGet();
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TaskCategoriesApi->taskCategoriesGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskCategoriesApi;

my $api_instance = WWW::SwaggerClient::TaskCategoriesApi->new();

eval { 
    my $result = $api_instance->taskCategoriesGet();
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TaskCategoriesApi->taskCategoriesGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
# create an instance of the API class
api_instance = swagger_client.TaskCategoriesApi()

try: 
    # Finds all task categories
    api_response = api_instance.task_categories_get()
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TaskCategoriesApi->taskCategoriesGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-taskCategoriesGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-taskCategoriesGet-200-schema">
                                  <div id='responses-taskCategoriesGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = ;
                                        var schema = schemaWrapper.content["application/json"].schema;
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-taskCategoriesGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-taskCategoriesGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-taskCategoriesGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-TaskCategories-taskCategoriesPost">
                      <article id="api-TaskCategories-taskCategoriesPost-0" data-group="User" data-name="taskCategoriesPost" data-version="0">
                        <div class="pull-left">
                          <h1>taskCategoriesPost</h1>
                          <p>Add a new task categories</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Menambahkan data task categories baru ke database</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="post"><code><span class="pln">/task_categories</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TaskCategories-taskCategoriesPost-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-java">Java</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPost-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TaskCategories-taskCategoriesPost-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X POST\
-H "Accept: application/json"\
-H "Content-Type: application/json"\
"https://mf-task-management.herokuapp.com/api/v1/task_categories"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
    ...
    public static void main(String[] args) {
        ...
        TaskCategoriesApi apiInstance = new TaskCategoriesApi();
        TaskCategories body = ; // TaskCategories | Create a new task categories
        try {
            TaskCategories result = apiInstance.taskCategoriesPost(body);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TaskCategoriesApi#taskCategoriesPost");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">TaskCategories *body = ; // Create a new task categories

TaskCategoriesApi *apiInstance = [[TaskCategoriesApi alloc] init];

// Add a new task categories
[apiInstance taskCategoriesPostWith:body
              completionHandler: ^(TaskCategories output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskCategoriesApi()
var body = ; // {{TaskCategories}} Create a new task categories
...
api.taskCategoriesPost(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskCategoriesPostExample
    {
        public void main()
        {

            var apiInstance = new TaskCategoriesApi();
            var body = new TaskCategories(); // TaskCategories | Create a new task categories
            ...
            {
                Debug.Print("Exception when calling TaskCategoriesApi.taskCategoriesPost: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskCategoriesApi();
$body = ; // TaskCategories | Create a new task categories

try {
    $result = $api_instance->taskCategoriesPost($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TaskCategoriesApi->taskCategoriesPost: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskCategoriesApi;

my $api_instance = WWW::SwaggerClient::TaskCategoriesApi->new();
my $body = WWW::SwaggerClient::Object::TaskCategories->new(); # TaskCategories | Create a new task categories

eval { 
    my $result = $api_instance->taskCategoriesPost(body => $body);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TaskCategoriesApi->taskCategoriesPost: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPost-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Add a new task categories
    api_response = api_instance.task_categories_post(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TaskCategoriesApi->taskCategoriesPost: %s\n" % e)</code></pre>
                            </div>
                          </div>
  ...
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_taskCategoriesPost_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_taskCategoriesPost_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-taskCategoriesPost-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-taskCategoriesPost-200-schema">
                                  <div id='responses-taskCategoriesPost-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = ;
                                        var schema = schemaWrapper.content["application/json"].schema;
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-taskCategoriesPost-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-taskCategoriesPost-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-taskCategoriesPost-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-TaskCategories-taskCategoriesPut">
                      <article id="api-TaskCategories-taskCategoriesPut-0" data-group="User" data-name="taskCategoriesPut" data-version="0">
                        <div class="pull-left">
                          <h1>taskCategoriesPut</h1>
                          <p>Update an existing task categories</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Update an existing task categories by Id</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="put"><code><span class="pln">/task_categories</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TaskCategories-taskCategoriesPut-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-java">Java</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesPut-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TaskCategories-taskCategoriesPut-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X PUT\
-H "Accept: application/json"\
-H "Content-Type: application/json"\
"https://mf-task-management.herokuapp.com/api/v1/task_categories"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
    ...
    public static void main(String[] args) {
        ...
        TaskCategoriesApi apiInstance = new TaskCategoriesApi();
        TaskCategories body = ; // TaskCategories | Update an existent task categories in the store
        try {
            TaskCategories result = apiInstance.taskCategoriesPut(body);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TaskCategoriesApi#taskCategoriesPut");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">TaskCategories *body = ; // Update an existent task categories in the store

TaskCategoriesApi *apiInstance = [[TaskCategoriesApi alloc] init];

// Update an existing task categories
[apiInstance taskCategoriesPutWith:body
              completionHandler: ^(TaskCategories output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskCategoriesApi()
var body = ; // {{TaskCategories}} Update an existent task categories in the store
...
api.taskCategoriesPut(body, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskCategoriesPutExample
    {
        public void main()
        {

            var apiInstance = new TaskCategoriesApi();
            var body = new TaskCategories(); // TaskCategories | Update an existent task categories in the store
            ...
            {
                Debug.Print("Exception when calling TaskCategoriesApi.taskCategoriesPut: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskCategoriesApi();
$body = ; // TaskCategories | Update an existent task categories in the store

try {
    $result = $api_instance->taskCategoriesPut($body);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TaskCategoriesApi->taskCategoriesPut: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskCategoriesApi;

my $api_instance = WWW::SwaggerClient::TaskCategoriesApi->new();
my $body = WWW::SwaggerClient::Object::TaskCategories->new(); # TaskCategories | Update an existent task categories in the store

eval { 
    my $result = $api_instance->taskCategoriesPut(body => $body);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TaskCategoriesApi->taskCategoriesPut: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesPut-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Update an existing task categories
    api_response = api_instance.task_categories_put(body)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TaskCategoriesApi->taskCategoriesPut: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                              <tr>
                                ...
                                $(document).ready(function() {
                                  var schemaWrapper = {
  "description" : "Update an existent task categories in the store",
  "content" : {
    "application/json" : {
      "schema" : {
        "$ref" : "#/components/schemas/TaskCategories"
  ...
  "required" : true
                                  ...
                                  var view = new JSONSchemaView(schema,2,{isBodyParam: true});
                                  var result = $('#d2e199_taskCategoriesPut_body');
                                  result.empty();
                                  result.append(view.render());
                                });
                                </script>
                                <div id="d2e199_taskCategoriesPut_body"></div>
                                </td>
                                </tr>
                            </table>
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-taskCategoriesPut-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-taskCategoriesPut-200-schema">
                                  <div id='responses-taskCategoriesPut-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = ;
                                        var schema = schemaWrapper.content["application/json"].schema;
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-taskCategoriesPut-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-taskCategoriesPut-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-taskCategoriesPut-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
                      ...
                      <hr>
                    <div id="api-TaskCategories-taskCategoriesTaskCategoriesIdDelete">
                      <article id="api-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0" data-group="User" data-name="taskCategoriesTaskCategoriesIdDelete" data-version="0">
                        <div class="pull-left">
                          <h1>taskCategoriesTaskCategoriesIdDelete</h1>
                          <p>Deletes a task categories</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">menghapus task categories sesuai id yang diberikan</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="delete"><code><span class="pln">/task_categories/{taskCategoriesId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-java">Java</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X DELETE\
"https://mf-task-management.herokuapp.com/api/v1/task_categories/{taskCategoriesId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
    ...
    public static void main(String[] args) {
        ...
        TaskCategoriesApi apiInstance = new TaskCategoriesApi();
        Long taskCategoriesId = 789; // Long | task categories id to delete
        try {
            apiInstance.taskCategoriesTaskCategoriesIdDelete(taskCategoriesId);
        } catch (ApiException e) {
            System.err.println("Exception when calling TaskCategoriesApi#taskCategoriesTaskCategoriesIdDelete");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Long *taskCategoriesId = 789; // task categories id to delete

TaskCategoriesApi *apiInstance = [[TaskCategoriesApi alloc] init];

// Deletes a task categories
[apiInstance taskCategoriesTaskCategoriesIdDeleteWith:taskCategoriesId
              completionHandler: ^(NSError* error) {
                            if (error) {
                                NSLog(@"Error: %@", error);
                            }
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskCategoriesApi()
var taskCategoriesId = 789; // {{Long}} task categories id to delete
...
api.taskCategoriesTaskCategoriesIdDelete(taskCategoriesId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskCategoriesTaskCategoriesIdDeleteExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling TaskCategoriesApi.taskCategoriesTaskCategoriesIdDelete: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskCategoriesApi();
$taskCategoriesId = 789; // Long | task categories id to delete

try {
    $api_instance->taskCategoriesTaskCategoriesIdDelete($taskCategoriesId);
} catch (Exception $e) {
    echo 'Exception when calling TaskCategoriesApi->taskCategoriesTaskCategoriesIdDelete: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskCategoriesApi;

my $api_instance = WWW::SwaggerClient::TaskCategoriesApi->new();
my $taskCategoriesId = 789; # Long | task categories id to delete

eval { 
    $api_instance->taskCategoriesTaskCategoriesIdDelete(taskCategoriesId => $taskCategoriesId);
};
if ($@) {
    warn "Exception when calling TaskCategoriesApi->taskCategoriesTaskCategoriesIdDelete: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdDelete-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Deletes a task categories
    api_instance.task_categories_task_categories_id_delete(taskCategoriesId)
except ApiException as e:
    print("Exception when calling TaskCategoriesApi->taskCategoriesTaskCategoriesIdDelete: %s\n" % e)</code></pre>
                            </div>
                          </div>
                          ...
                          <h2>Parameters</h2>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <tr><td style="width:150px;">taskCategoriesId*</td>
                                  <td>
                                  
                                  
                                      <div id="d2e199_taskCategoriesTaskCategoriesIdDelete_taskCategoriesId">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Long
                          ...
                          <h2>Responses</h2>
                            <h3> Status: 400 - Invalid task categories value </h3>
                      ...
                      <hr>
                    <div id="api-TaskCategories-taskCategoriesTaskCategoriesIdGet">
                      <article id="api-TaskCategories-taskCategoriesTaskCategoriesIdGet-0" data-group="User" data-name="taskCategoriesTaskCategoriesIdGet" data-version="0">
                        <div class="pull-left">
                          <h1>taskCategoriesTaskCategoriesIdGet</h1>
                          <p>Find task categories by id</p>
                        </div>
                        <div class="pull-right"></div>
                        <div class="clearfix"></div>
                        <p></p>
                        <p class="marked">Mengambil data task categories sesuai id yang diberikan</p>
                        <p></p>
                        <br />
                        <pre class="prettyprint language-html prettyprinted" data-type="get"><code><span class="pln">/task_categories/{taskCategoriesId}</span></code></pre>
                        <p>
                          <h3>Usage and SDK Samples</h3>
                        </p>
                        <ul class="nav nav-tabs nav-tabs-examples">
                          <li class="active"><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-curl">Curl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-java">Java</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-android">Android</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-groovy">Groovy</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-objc">Obj-C</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-javascript">JavaScript</a></li>
                          <!--<li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-angular">Angular</a></li>-->
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-csharp">C#</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-php">PHP</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-perl">Perl</a></li>
                          <li class=""><a href="#examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-python">Python</a></li>
                        </ul>

                        <div class="tab-content">
                          <div class="tab-pane active" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-curl">
                           <pre class="prettyprint"><code class="language-bsh">curl -X GET\
-H "Accept: application/json"\
"https://mf-task-management.herokuapp.com/api/v1/task_categories/{taskCategoriesId}"</code></pre>
                          </div>
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-java">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.*;
import io.swagger.client.auth.*;
import io.swagger.client.model.*;
import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
    ...
    public static void main(String[] args) {
        ...
        TaskCategoriesApi apiInstance = new TaskCategoriesApi();
        Integer taskCategoriesId = 56; // Integer | id to filter
        try {
            array[TaskCategories] result = apiInstance.taskCategoriesTaskCategoriesIdGet(taskCategoriesId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling TaskCategoriesApi#taskCategoriesTaskCategoriesIdGet");
            e.printStackTrace();
        }
    }
}</code></pre>
                          ...
                          <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-android">
                            <pre class="prettyprint"><code class="language-java">import io.swagger.client.api.TaskCategoriesApi;
...
public class TaskCategoriesApiExample {
  ...
  <!--
  <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-groovy">
  <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
  </div> -->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-objc">
                              <pre class="prettyprint"><code class="language-cpp">Integer *taskCategoriesId = 56; // id to filter

TaskCategoriesApi *apiInstance = [[TaskCategoriesApi alloc] init];

// Find task categories by id
[apiInstance taskCategoriesTaskCategoriesIdGetWith:taskCategoriesId
              completionHandler: ^(array[TaskCategories] output, NSError* error) {
                            if (output) {
                                NSLog(@"%@", output);
                            }
                            if (error) {
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-javascript">
                              <pre class="prettyprint"><code class="language-js">var TaskManagementOpenApi10 = require('task_management___open_api_10');

var api = new TaskManagementOpenApi10.TaskCategoriesApi()
var taskCategoriesId = 56; // {{Integer}} id to filter
...
api.taskCategoriesTaskCategoriesIdGet(taskCategoriesId, callback);
</code></pre>
                            </div>

                            <!--<div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-angular">
              <pre class="prettyprint language-json prettyprinted" data-type="json"><code>Coming Soon!</code></pre>
            </div>-->
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-csharp">
                              <pre class="prettyprint"><code class="language-cs">using System;
using System.Diagnostics;
using IO.Swagger.Api;
using IO.Swagger.Client;
...
namespace Example
{
    public class taskCategoriesTaskCategoriesIdGetExample
    {
        public void main()
        {
            ...
            {
                Debug.Print("Exception when calling TaskCategoriesApi.taskCategoriesTaskCategoriesIdGet: " + e.Message );
            }
        }
    }
}
                            ...
                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-php">
                              <pre class="prettyprint"><code class="language-php"><&#63;php
require_once(__DIR__ . '/vendor/autoload.php');

$api_instance = new Swagger\Client\ApiTaskCategoriesApi();
$taskCategoriesId = 56; // Integer | id to filter

try {
    $result = $api_instance->taskCategoriesTaskCategoriesIdGet($taskCategoriesId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling TaskCategoriesApi->taskCategoriesTaskCategoriesIdGet: ', $e->getMessage(), PHP_EOL;
}
?></code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-perl">
                              <pre class="prettyprint"><code class="language-perl">use Data::Dumper;
use WWW::SwaggerClient::Configuration;
use WWW::SwaggerClient::TaskCategoriesApi;

my $api_instance = WWW::SwaggerClient::TaskCategoriesApi->new();
my $taskCategoriesId = 56; # Integer | id to filter

eval { 
    my $result = $api_instance->taskCategoriesTaskCategoriesIdGet(taskCategoriesId => $taskCategoriesId);
    print Dumper($result);
};
if ($@) {
    warn "Exception when calling TaskCategoriesApi->taskCategoriesTaskCategoriesIdGet: $@\n";
}</code></pre>
                            </div>

                            <div class="tab-pane" id="examples-TaskCategories-taskCategoriesTaskCategoriesIdGet-0-python">
                              <pre class="prettyprint"><code class="language-python">from __future__ import print_statement
import time
import swagger_client
from swagger_client.rest import ApiException
...
try: 
    # Find task categories by id
    api_response = api_instance.task_categories_task_categories_id_get(taskCategoriesId)
    pprint(api_response)
except ApiException as e:
    print("Exception when calling TaskCategoriesApi->taskCategoriesTaskCategoriesIdGet: %s\n" % e)</code></pre>
                            </div>
                          </div>
                            ...
                            <table id="methodsubtable">
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div id="d2e199_taskCategoriesTaskCategoriesIdGet_taskCategoriesId">
                                          <div class="json-schema-view">
                                              <div class="primitive">
                                                  <span class="type">
                                                      Integer
                          ...
                          <h2>Responses</h2>
                            ...
                            <ul class="nav nav-tabs nav-tabs-examples" >
                                <li class="active">
                                  <a data-toggle="tab" href="#responses-taskCategoriesTaskCategoriesIdGet-200-schema">Schema</a>
                                </li>

                            </ul>

                            <div class="tab-content" style='margin-bottom: 10px;'>
                                <div class="tab-pane active" id="responses-taskCategoriesTaskCategoriesIdGet-200-schema">
                                  <div id='responses-taskCategoriesTaskCategoriesIdGet-200-schema-200' style="padding: 30px; border-left: 1px solid #eee; border-right: 1px solid #eee; border-bottom: 1px solid #eee;">
                                    <script>
                                      $(document).ready(function() {
                                        var schemaWrapper = ;
                                        var schema = schemaWrapper.content["application/json"].schema;
                                        ...
                                        //console.log(JSON.stringify(schema));
                                        var view = new JSONSchemaView(schema, 3);
                                        $('#responses-taskCategoriesTaskCategoriesIdGet-200-schema-data').val(stringify(schema));
                                        var result = $('#responses-taskCategoriesTaskCategoriesIdGet-200-schema-200');
                                        result.empty();
                                        result.append(view.render());
                                      });
                                    </script>
                                  </div>
                                  <input id='responses-taskCategoriesTaskCategoriesIdGet-200-schema-data' type='hidden' value=''></input>
                                </div>
                            </div>
          ...
          <div id="footer">
            <div id="api-_footer">
              <p>Suggestions, contact, support and error reporting;
                  ...
                  <div class="app-desc">Contact Info: <a href="fahrizalm84@gmail.com">fahrizalm84@gmail.com</a></div>
              </p>
